...
import static org.telegram.sword.app.home.util.OnlineUsersKt.updateContactsArray;
...
public class ContactsController extends BaseController {
    ...
    public String getInviteText(int contacts) {
        String link = "https://app.swordpay.com/";
        if (contacts <= 1) {
            return LocaleController.formatString("InviteText2Sword", R.string.InviteText2Sword, link);
        } else {
            try {
    ...
    public void checkAppAccount() {
        ...
        try {
            Account[] accounts = am.getAccountsByType("com.swordpay.me");
            systemAccount = null;
        ...
        if (getUserConfig().isClientActivated()) {
            ...
            if (systemAccount == null) {
                try {
                    systemAccount = new Account("" + getUserConfig().getClientUserId(), "com.swordpay.me");
    ...
    protected void performSyncPhoneBook(final HashMap<String, Contact> contactHashMap, final boolean request, final boolean first, final boolean schedule, final boolean force, final boolean checkCount, final boolean canceled) {
        if (!first && !contactsBookLoaded) {
            Log.e("fvhjuhbjf","aaaaaaaaaaaaaaaa");
            return;
        }
        Utilities.globalQueue.postRunnable(() -> {
            ...
            if (request) {
                ...
                Log.e("hfbvjbvjfv","aaaaaaaaaaaaaaaa");
                if (!toImport.isEmpty()) {

                    Log.e("hfbvjbvjfv","22222222222222");
                    ...
                    Log.e("hfbvjbvjfv","666666666666666");
                    ...
                    for (int a = 0; a < count; a++) {
                        ...
                        getConnectionsManager().sendRequest(req, (response, error) -> {
                            ...
                            if (completedRequestsCount == count) {
                                Log.e("hfbvjbvjfv","777777777777777");
                ...
                if (!contactsMap.isEmpty()) {
                    Log.e("hfbvjbvjfv","44444444444444");
                    getMessagesStorage().putCachedPhoneBook(contactsMap, false, false);
                }
            }
        });
...
//                    Log.e("fvjikfvnfv",""+jj.size());
    ...
    public void processLoadedContacts(final ArrayList<TLRPC.TL_contact> contactsArr, final ArrayList<TLRPC.User> usersArr, final int from) {
        ...
        AndroidUtilities.runOnUIThread(() -> {
            ...
            Utilities.stageQueue.postRunnable(() -> {
                ...
                updateContactsArray((ArrayList<TLRPC.TL_contact>)contactsArr);

                Log.e("bvjfbvjvfv",""+contactsArr.size());
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> query, TLRPC.User user) {
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.swordpay.me.android.profile");
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.swordpay.me.android.call");
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.swordpay.me.android.call.video");
        builder.withValue(ContactsContract.Data.DATA1, user.id);
