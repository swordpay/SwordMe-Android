                    ...
                    if (data != null) {
                        ...
                        switch (type) {
                            ...
                            case 14: {
                                ...
                                Log.e("dkvnjfnbfv","111111111111111");
                            ...
                            case 4: {
                                ...
                                Log.e("dkvnjfnbfv","333333333333333");
                                break;
                            }
                            case 6: {
                                long channelId = data.readInt32(false);
                            ...
                            case 9: {
                                ...
                                Log.e("dkvnjfnbfv","44444444444444");
                                break;
                            }
                            case 11: {
...
//
//                        if ((users.get(i).status).toString().contains("userStatusOnline")){
//                            Log.e("dvnhjnf",(users.get(i).first_name).toString());
//
//                        }
//
//                    }
...
//                }
    ...
    public ArrayList<TLRPC.User> getOnlineUsers() {

            ArrayList<TLRPC.TL_contact> contacts = new ArrayList<>();
            ArrayList<TLRPC.User> users = new ArrayList<>();
            ArrayList<TLRPC.User> onlineUsers = new ArrayList<>();
            SQLiteCursor cursor = null;
            try {
                cursor = database.queryFinalized("SELECT * FROM contacts WHERE 1");
                StringBuilder uids = new StringBuilder();
            ...
            ArrayList<TLRPC.TL_contact> onlineContacts = new ArrayList<TLRPC.TL_contact>(contacts);
                long selfId = UserConfig.getInstance(currentAccount).clientUserId;
                for (int a = 0, N = onlineContacts.size(); a < N; a++) {
                    if (onlineContacts.get(a).user_id == selfId) {
                        onlineContacts.remove(a);
            ...
            try {
                for (int i = 0; i < users.size(); i++) {
//                    Log.e("dvnhjnf",(users.get(i).status).toString());
                    if ((users.get(i).status).toString().contains("userStatusOnline")){
//                        Log.e("sdcddvdv",(users.get(i).first_name).toString());

                        onlineUsers.add(0,users.get(i));

                    }


                    if ((users.get(i).status).toString().contains("userStatusRecently")){
