...
import org.telegram.customqrgenerator.encoder.QrCodeMatrix
import org.telegram.customqrgenerator.encoder.neighbors
import org.telegram.customqrgenerator.encoder.toQrMatrix
import org.telegram.customqrgenerator.fit
import org.telegram.customqrgenerator.style.EmptyDrawable
                ...
                when {
                    ...
                    options.highlighting.versionEyes !is HighlightingType.None &&
                        ...
                        if (options.colors.frame is QrVectorColor.Unspecified) {
                            ...
                            val shape =
                                DefaultVersionFrame.createPath(pixelSize * 5, Neighbors.Empty)
