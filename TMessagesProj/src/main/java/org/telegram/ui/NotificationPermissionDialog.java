...
public class NotificationPermissionDialog extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public NotificationPermissionDialog(Context context, Utilities.Callback<Boolean> whenGranted) {
        ...
        textView.setText(LocaleController.getString("NotificationsPermissionAlertTitleSword"));
        ...
        textView.setGravity(Gravity.CENTER_HORIZONTAL);
        textView.setText(LocaleController.getString("NotificationsPermissionAlertSubtitleSword"));
        textView.setPadding(AndroidUtilities.dp(30), AndroidUtilities.dp(10), AndroidUtilities.dp(30), AndroidUtilities.dp(21));
        linearLayout.addView(textView, LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT));

        linearLayout.addView(new SectionView(context, LocaleController.getString("NotificationsPermissionAlert1Sword")), LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT));
        linearLayout.addView(new SectionView(context, LocaleController.getString("NotificationsPermissionAlert2Sword")), LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT));
        linearLayout.addView(new SectionView(context, LocaleController.getString("NotificationsPermissionAlert3Sword")), LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT));

        setCustomView(linearLayout);
        fixNavigationBar(getThemedColor(Theme.key_dialogBackground));

        textView = new TextView(context);
        textView.setText(LocaleController.getString("NotificationsPermissionContinueSword"));
...
//            strokePaint.setColor(Theme.getColor(Theme.key_dialogBackground));
    ...
    private static class SectionView extends FrameLayout {
        public SectionView(Context context, CharSequence text) {
            super(context);
