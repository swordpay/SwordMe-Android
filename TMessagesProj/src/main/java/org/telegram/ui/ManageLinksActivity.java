...
public class ManageLinksActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemLongClickListener((view, position) -> {
            Log.e("ddvdvdvhvujfjv","long hhhhhhhhhhhhhhhhhh");
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(Context context) {
            ...
            messageTextView.setText(isChannel ? LocaleController.getString("PrimaryLinkHelpChannelSword", R.string.PrimaryLinkHelpChannelSword) : LocaleController.getString("PrimaryLinkHelp", R.string.PrimaryLinkHelp));
            ...
            switch (holder.getItemViewType()) {
                case 2:
                    ...
                    if (isPublic && adminId == getAccountInstance().getUserConfig().clientUserId) {
                        if (info != null) {
                            linkActionView.setLink("https://"+SWORD_LINK_PREFIX+"/" + ChatObject.getPublicUsername(currentChat));
//
...
//            Log.e("djbvjdbd",""+invite.title);
            ...
            if (!TextUtils.isEmpty(invite.title)) {
            ...
            } else if (invite.link.startsWith("https://t.me/+") || invite.link.startsWith("https://"+SWORD_LINK_PREFIX+"/+")) {
                ...
                if (invite.link.startsWith("https://t.me/+")){
                    ...
                    titleView.setText(invite.link.substring(("https://"+SWORD_LINK_PREFIX+"/+").length()));
                }



            } else if (invite.link.startsWith("https://t.me/joinchat/") || invite.link.startsWith("https://"+SWORD_LINK_PREFIX+"/joinchat/")) {

                if (invite.link.startsWith("https://t.me/joinchat/")){

                    titleView.setText(invite.link.substring("https://t.me/joinchat/".length()));

                }else {

                    String l = "https://"+SWORD_LINK_PREFIX+"/joinchat/";

                    titleView.setText(invite.link.substring(l.length()));
                }
