    ...
    public View createView(Context context) {
        ...
        switch (currentType) {
            ...
            case TYPE_ENTER_EMAIL: {
                ...
                outlineTextFirstRow = new OutlineTextContainerView(context,false);
                ...
                outlineTextSecondRow = new OutlineTextContainerView(context,false);
                ...
                if (error == null && (response instanceof TLRPC.TL_boolTrue || response instanceof TLRPC.auth_Authorization)) {
                    ...
                    if ("EMAIL_UNCONFIRMED".equals(error.text) || error.text.startsWith("EMAIL_UNCONFIRMED_")) {
                        ...
                        if ("EMAIL_INVALID".equals(error.text)) {
                            showAlertWithText(LocaleController.getString("AppShortName", R.string.AppShortName), LocaleController.getString("PasswordEmailInvalid", R.string.PasswordEmailInvalid));
                        } else if (error.text.startsWith("FLOOD_WAIT")) {
                            int time = Utilities.parseInt(error.text);
                            String timeString;
                            if (time < 60) {
