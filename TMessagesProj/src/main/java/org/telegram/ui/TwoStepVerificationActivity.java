...
public class TwoStepVerificationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        passwordOutlineView = new OutlineTextContainerView(context,false);
        ...
        linearLayout.addView(passwordOutlineView, LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL, 16, 10, 16, 0));
...
//        passwordEditText.setHintTextColor(Color.parseColor("#C6C6C8"));
//        passwordEditText.setTextColor(Color.parseColor("#2F3032"));
//        passwordEditText.setBackground(null);
//        passwordEditText.setSingleLine(true);
...
//        passwordEditText.setCursorWidth(1.5f);
//        passwordEditText.setContentDescription(LocaleController.getString(R.string.EnterPassword));
//        passwordEditText.setPadding(AndroidUtilities.dp(16), AndroidUtilities.dp(16), AndroidUtilities.dp(16), AndroidUtilities.dp(16));
//        passwordOutlineView.addView(passwordEditText, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT));
//        passwordOutlineView.attachEditText(passwordEditText);
//        linearLayout.addView(line);
        ...
        passwordEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                Log.e("fjvknjnbk","eeeeeeeeeeeeeeee");
            ...
            ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
                ...
                if (error == null) {
                    ...
                    if (error.text.startsWith("FLOOD_WAIT")) {
                        ...
                        showAlertWithText(LocaleController.getString("AppShortName", R.string.AppShortName), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, timeString));
                    } else {
                        showAlertWithText(LocaleController.getString("AppShortName", R.string.AppShortName), error.text);
                    }
                }
    ...
    private void updateRows() {
        Log.e("fjvknjnbk","66666666666666");
