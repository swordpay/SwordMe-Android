...
import org.telegram.sword.sendOrRequest.SendOrRequest;
...
public class ContactsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static TLRPC.User  userInProcess = null;
    public static Boolean  goToUserChat = false;
    ...
    public static BitmapDrawable avatar;
    public static AvatarDrawable avatarDrawable;
//    private RLottieImageView floatingButton;
    ...
    public ContactsActivity(Bundle args,String title) {
        super(args);
        isDrawer = false;
...
//                }
        ...
        listViewAdapter = new ContactsAdapter(context, onlyUsers ? 1 : 0, needPhonebook, inviteViaLink, hasGps) {
            @Override
                                    ...
                                    try {
                                        ...
                                        if (createSecretChat) {
                                            ...
                                            Intent intent;
                                             ...
                                             intent = new Intent(ApplicationLoader.applicationContext, SendOrRequest.class);
                                            ...
                                            TLRPC.InputPeer inputPeer = getMessagesController().getInputPeer(((TLRPC.User) user).id);

                                            TeleUserInfo userInfo = new TeleUserInfo(
                                                    null,
                                                    inputPeer.id,
                                                    user.username,
                                                    user.first_name,
                                                    user.last_name,
                                                    String.valueOf(inputPeer.access_hash),
                                                    inputPeer.type,
                                                    false
                                            );

                                            intent.putExtra("SharedExtraData", (Serializable) userInfo);
    ...
    public void onResume() {
        ...
        if (userInProcess!=null && goToUserChat){


           Bundle args = new Bundle();
           args.putLong("user_id", userInProcess.id);
           if (getMessagesController().checkCanOpenChat(args, ContactsActivity.this)) {
               presentFragment(new ChatActivity(args), true);
           }
