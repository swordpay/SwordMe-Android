...
public class PhotoCropActivity extends BaseFragment {
    ...
    public boolean onFragmentCreate() {
        if (imageToCrop == null) {
            String photoPath = getArguments_().getString("photoPath");
            Uri photoUri = getArguments_().getParcelable("photoUri");
    ...
    public View createView(Context context) {
        ...
        ((PhotoCropView) fragmentView).freeform = getArguments_().getBoolean("freeform", false);
