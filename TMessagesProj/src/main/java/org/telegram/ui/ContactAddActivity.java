...
public class ContactAddActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public boolean onFragmentCreate() {
        ...
        user_id = getArguments_().getLong("user_id", 0);
        phone = getArguments_().getString("phone");
        firstNameFromCard = getArguments_().getString("first_name_card");
        lastNameFromCard = getArguments_().getString("last_name_card");
        addContact = getArguments_().getBoolean("addContact", false);
