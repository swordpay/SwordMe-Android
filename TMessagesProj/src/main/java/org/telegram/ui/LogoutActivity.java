...
public class LogoutActivity extends BaseFragment {
    ...
    public static AlertDialog makeLogOutDialog(Context context, int currentAccount) {
        ...
        builder.setMessage(LocaleController.getString("AreYouSureLogoutText", R.string.AreYouSureLogoutText));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return  position == passcodeRow || position == cacheRow  || position == supportRow || position == logoutRow;
        }
        ...
        public int getItemViewType(int position) {
            if (position == alternativeHeaderRow) {
                return 0;
            } else if (position == passcodeRow || position == cacheRow || position == supportRow) {
                return 1;
