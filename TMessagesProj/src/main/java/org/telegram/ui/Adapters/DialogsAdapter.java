...
//            Log.e("dkvnkjnvf","SystemClock    "+((SystemClock.elapsedRealtime() - lastSortTime) < 2000));
//            Log.e("dkvnkjnvf","onlineContacts   "+onlineContacts);
//            Log.e("dkvnkjnvf",""+"null onlaynCont");
            return;
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view;
//        Log.e("fnvjfnf",String.valueOf(viewType));
        switch (viewType) {
            ...
            case VIEW_TYPE_LAST_EMPTY: {
                view = new LastEmptyView(mContext,true);
                break;
            }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        Log.e("jbjhbj",String.valueOf(holder.getItemViewType()));
        switch (holder.getItemViewType()) {
            ...
            case VIEW_TYPE_HEADER: {
                ...
                if (
                    ...
                    cell.setText(LocaleController.getString(dialogsCount == 0 && forceUpdatingContacts ? R.string.ConnectingYourContacts : R.string.YourContactsSword));
                }
                break;
            }
            case VIEW_TYPE_HEADER_2: {
            ...
            case VIEW_TYPE_NEW_CHAT_HINT: {
                ...
                FrameLayout footer = new FrameLayout(mContext);
...
//                textView.getLayoutParams().width = LayoutHelper.MATCH_PARENT;
                break;
            }
            case VIEW_TYPE_TEXT: {
    ...
    public class LastEmptyView extends View {
        ...
        public boolean isRooms=false;

        public LastEmptyView(Context context) {
            super(context);
        }

        public LastEmptyView(Context context,boolean isRooms) {
            super(context);
