...
public class OutlineTextContainerView extends FrameLayout {
    ...
    private boolean isSwordStyle = false;
    ...
    public OutlineTextContainerView(Context context,boolean isSwordStyle) {
        super(context);
        setWillNotDraw(false);
        this.isSwordStyle = isSwordStyle;
...
//        outlinePaint.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawView = new DrawView(getContext().getApplicationContext());
