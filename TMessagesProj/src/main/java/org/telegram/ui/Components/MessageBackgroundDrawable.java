...
import static org.telegram.messenger.utils.SwordColors.RED;
...
public class MessageBackgroundDrawable extends Drawable {
    ...
    public MessageBackgroundDrawable(View parent) {
        Log.e("edfbjbjbv","XXXXXXXXXXXXXXXXXX");
        parentView = parent;

    }

    public void setColor(int color) {
        Log.e("edfbjbjbv","setColor");
//        paint.setColor(APP_BLUE);
    ...
    public void setColorFilter(ColorFilter colorFilter) {
        Log.e("edfbjbjbv","setColorFilter");
        paint.setColorFilter(new PorterDuffColorFilter(RED, PorterDuff.Mode.MULTIPLY));
