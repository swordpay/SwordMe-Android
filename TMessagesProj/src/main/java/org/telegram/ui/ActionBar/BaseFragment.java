...
import static org.telegram.sword.domain.common.BaseDataSourceKt.getBlockedUser;
import static org.telegram.sword.domain.common.HttpInterceptorKt.refreshForceLogOutSession;
...
public abstract class BaseFragment extends Fragment {
    ...
    public  int nexPage = 0;

    public boolean hasNext = false;

    public  boolean isFirstFetTransaction = true;

    public String transactionsSectionHeader = " ";

    public void userBlockedDialog(Context context, String message) {
    ...
    public void forceLogoutSessionExpireAccountDialog(Context context) {
        ...
        dialogTitle.setText(context.getString(R.string.sessionExpiredForceLogOutMessage));
    ...
    public void infoDialog(Context context, String title,String message,String btnText) {
        ...
        if (message == null){
            ...
            dialogDesc.setVisibility(View.GONE);
        }else {
    ...
    public void forceUpdate(Context context) {
        ...
        Dialog dialog = new Dialog(context);
            ...
            TextView dialogDesc = dialog.findViewById(R.id.dialogDesc);
            RoundedImageView dialogStatusIcon= dialog.findViewById(R.id.messageDialogStatusIcon);
            AppCompatTextView dialogBtn = dialog.findViewById(R.id.dialogBtn);
            AppCompatTextView dismissBtn= dialog.findViewById(R.id.dismissBtn);
            dialogTitle.setText(R.string.updateApp);
            dialogDesc.setText(R.string.app_update_info);
            dialogStatusIcon.setImageResource(R.drawable.ic_play_market_icon);
            ...
            dialogBtn.setOnClickListener(v -> {
                ...
                try {
//                    getParentActivity().startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.swordpay.me")));
    ...
    public void onResume() {
        ...
        Log.e("fnkddjbnjb","onResume");
        getBlockedUser().observe(this, new Observer<String>() {

            @Override
            public void onChanged(String s) {
                Log.e("fnkddjbnjb","message     "+s);
            }
        });
    }
    ...
    public AppCompatActivity getParentAppCompatActivity() {
        if (parentLayout != null) {
            return parentLayout.getParentAppCompatActivity();
        }
        return null;
    }
